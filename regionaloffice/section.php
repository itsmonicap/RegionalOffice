...
<?php }?> </span>
        ...
        <h5 align="center" style="font-size:24px; color:#000;">Sections</h5>
...
<li><a href="student-section.html">Student Section</a></li>
                    <li><a href="establishment-section.html">Establishment Section</a></li>
                    <li><a href="accounts-section.html">Accounts Section</a></li>
                    </ul>
    ...
    <nav id="mainav" class="clear" style="margin-left:7px;"> 
      ...
      <ul class="clear">
        ...
        <li><a class="drop" href="about.php">About Us</a>
         ...
         <li class="active"><a class="drop" href="section.php">Sections</a>
          <ul>
            <li><a href="studentsection.php">Student Section</a></li>
            <li><a href="establishmentsection.php">Establishment Section</a></li>
            <li><a href="accountsection.php">Accounts Section</a></li>
