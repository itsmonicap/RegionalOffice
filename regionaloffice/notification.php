    ...
    <nav id="mainav" class="clear" style="margin-left:7px;"> 
      ...
      <ul class="clear">
        ...
        <li ><a class="drop" href="about.php">About Us</a>
         ...
         <li class="active"><a  href="notification.php">Notifications</a>
...
<?php }?> </span>
        ...
        <h5 align="center" style="font-size:24px; color:#000;">Exam Section</h5>
  ...
  <div class="panel-heading">Exam Section</div>
  <div class="panel-body" style="color:#000;">
         <table class="table-striped">
             ...
             <tr>
                 <td>Hotel Management and cattering technology</td>
                 <td>22 May 2016</td>
             </tr>
             <tr>
                 <td>MHMCT</td>
             ...
             <tr>
                 <td>Engineering and Pharmacy</td>
                 <td>5 May 2016</td>
             </tr>
