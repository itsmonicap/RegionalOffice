...
<?php }?> </span>
         ...
         <h5 align="center" style="font-size:24px; color:#000;">Circulars</h5>
        <div class="one_half" style="margin-left:-74px;"> 
        
          
          <div class="sdb_holder" style="margin-right: -178px;
    margin-left: 60px;">
        <table border="0" align="center" id="table1" cellpadding="20" cellspacing="20" width="80%" class="table" style="border-color:#000;">

<tr  style="font-size:16px; color:#000;background-color:#999;border-color:#000;"><td style="color:#000;border-color:#000;">Sr.No.</td><td style="color:#000;border-color:#000;">Date of Posting</td><td style="color:#000;border-color:#000;">Subject</td><td style="color:#000;border-color:#000;">Download</td></tr>
...
<td style="color:#000;border-color:#000;"><?php echo $row1['dateofposting']; ?></td>
<td style="color:#000;border-color:#000;"><?php echo $row1['subject']; ?></td>
<?php /*?><td><a href="admin/files/<?php echo $row1['file'] ?>" target="_blank" style="color:#FFF" >view file</a></td><?php */?>
<td width="150" style="color:#000;border-color:#000;">
<img alt="down-icon" src="images/pdficon.gif" align="left" width="20" height="20"/>
<a href="download.php?filename=<?php echo $file ;?>" style="color:#000">
Download</a></td></tr>
