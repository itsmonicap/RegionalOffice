...
$insert=mysqli_query($con,'insert into circular(dateofposting,subject,file,type)values("'.$_POST['date'].'","'.$_POST['subject'].'","'.$name.'","'.$type.'")');
...
if($insert){
	...
	echo 'window.location.href = "circular.php";'; 
    echo '</script>';
	//echo 'successfully';
//header("location:index.php");
}
...
?>
       ...
       <form action="<?php $_PHP_SELF?>" method="post" onSubmit="return validateForm()" name="myForm" enctype="multipart/form-data">
       <br><br>
        <table class="table">
