...
<?php }?> </span>
        ...
        <li class='btn btn-danger btn-sm' style="float:right;margin-top: -61px;margin-right: -552px; color:#FFF;"><a href="logout.php"><span style="color:#FFF;">Logout</span></a></li>
...
<tr  style="font-size:16px; color:#000;background-color:#999;border-color:#000;"><td style="color:#000;border-color:#000;">Sr.No.</td><td style="color:#000;border-color:#000;">Course Name</td><td style="color:#000;border-color:#000;">Code</td><td style="color:#000;border-color:#000;">Admitted Students</td><td style="color:#000;border-color:#000;">EBC Students</td><td style="color:#000;border-color:#000;">Passout Students</td><td style="color:#000;border-color:#000;">Drops Students</td><td style="color:#000;border-color:#000;">Leftout Students</td></tr>
   
         
         <?php 
   include('config.php');
	$query1 = "SELECT * FROM webform ";
	$result = mysqli_query($con,$query1);
?>
         <?php
while($row1=mysqli_fetch_array($result))
{
	$cousename=$row1['cousename'];
	$code=$row1['code'];
	$admitted=$row1['admitted'];
	$ebc=$row1['ebc'];
	$passout=$row1['passout'];
	$drops=$row1['drops'];
	$leftout=$row1['leftout'];
	?>

<tr style="color:#000;border-color:#000;">
<td style="color:#000;border-color:#000;"><?php echo $row1['id']; ?></td>
<td style="color:#000;border-color:#000;"><?php echo $row1['cousename']; ?></td>
<td style="color:#000;border-color:#000;"><?php echo $row1['code']; ?></td>
<td style="color:#000;border-color:#000;"><?php echo $row1['admitted']; ?></td>
<td style="color:#000;border-color:#000;"><?php echo $row1['ebc']; ?></td>
<td style="color:#000;border-color:#000;"><?php echo $row1['passout']; ?></td>
<td style="color:#000;border-color:#000;"><?php echo $row1['drops']; ?></td>
<td style="color:#000;border-color:#000;"><?php echo $row1['leftout']; ?></td>
</tr>
