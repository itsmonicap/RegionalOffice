    ...
    <nav id="mainav" class="clear" style="margin-left:7px;"> 
      ...
      <ul class="clear">
        ...
        <li ><a class="drop" href="about.php">About Us</a>
          ...
          <li class="active"><a href="citizencharter.php">Citizen Charter</a></li>
...
<?php }?> </span>
         ...
         <h5 align="center" style="font-size:24px; color:#000;">Citizen Charter</h5>
  ...
  <div class="panel-heading">Citizen Charter</div>
  <div class="panel-body" style="color:#000;">
     <div id="content-wrapper" style="margin-top:0px;"><h1></h1>
         
        <ul class="cList pointLi">
					<li><a href="master-panel/files/CitizenCharter.pdf" target="blank"><font size="5">  Citizen Charter ( Nagrikanchi Sanad )</font></a></li>

                    </ul><p style="height:150px;">
