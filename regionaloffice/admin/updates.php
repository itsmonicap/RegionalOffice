      ...
      <ul class="clear">
        ...
        <li ><a class="drop" href="about.php">About Us</a>
         ...
         <li><a href="citizencharter.php">Citizen Charter</a></li>
          ...
          <li class="active"><a href="updates.php">Latest Updates</a></li>
...
<?php }?> </span>
         ...
         <h5 align="center" style="font-size:24px; color:#000;">Latest Updates</h5>
...
if($insert){
	...
	echo 'window.location.href = "updates.php";'; 
    echo '</script>';
	//echo 'successfully';
//header("location:index.php");
}
