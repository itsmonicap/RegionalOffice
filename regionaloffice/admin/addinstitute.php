    ...
    <nav id="mainav" class="clear" style="margin-left:7px;"> 
      ...
      <ul class="clear">
        ...
        <li ><a class="drop" href="about.html">About Us</a>
         ...
         <li class="active"><a href="currentnews.php">Current News</a></li>
...
<?php }?> </span>
         ...
         <h5 align="center" style="font-size:24px; color:#000;">Register Institute</h5>
...
$insert=mysqli_query($con,'insert into institutelogin(institute_name,username,cpassword)values("'.$_POST['institute_name'].'","'.$_POST['username'].'","'.$_POST['cpassword'].'")') or die(mysqli_error($con));
...
if($insert){
	...
	echo 'window.location.href = "addinstitute.php";'; 
    echo '</script>';
	//echo 'successfully';
//header("location:index.php");
}
...
?>
       ...
       <form  method="post" id="chng_pwd_form" name="change_pass" >
       <br><br>
        <table class="table">
