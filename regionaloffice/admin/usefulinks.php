      ...
      <ul class="clear">
       <li><a href="home.php">Home</a></li>
        <li><a class="drop" href="about.php">About Us</a>
         ...
         <li  class="active"><a href="usefulinks.php">Useful Links</a> </li>
...
<?php }?> </span>
        ...
        <h5 align="center" style="font-size:24px; color:#000;">Usefull Links</h5>
  ...
  <div class="panel-heading">Usefull Links</div>
  <div class="panel-body" style="color:#000;">
         
       <ul class="cList pointLi">
					<li><a target="_blank" href="http://www.aicte.ernet.in"> All India Council of Technical Education, Delhi</a></li>
                    <li><a target="_blank" href="http://www.maharashtra.gov.in"> Government of Maharashtra </a></li>
                    <li> <a target="_blank" href="http://www.dte.org.in"> Directorate of Technical Education,M.S.Mumbai </a></li>
                    <li> <a target="_blank" href="http://www.msbte.com"> Maharashtra State Board of Technical Education, Mumbai </a></li>
                    <li> <a target="_blank" href="http://www.nmu.ac.in"> North Maharashtra University, Jalgaon </a></li>
                    <li> <a target="_blank" href="http://www.unipune.ernet.in"> Pune University, Pune </a></li>
                    <li> <a target="_blank" href="http://www.oopswatches.com"> Replica Breitling Watches </a></li>
                    </ul>
    ...
    margin-left: 215px;margin-top: 53px;">
